...
// }
//
// static void FFT::fft(const PlotDataPtr &x_data, std::vector<QPointF> &f_data)
// {
// 	// Fill the _x vector
...
//
// 	// Perform FFT
// 	ComplexVector X = difft2(0, power, 1);
//
// 	// Build output
// 	f_data.resize(power);
...
// 	{
// 		QPointF p(k*fs/power, std::abs(X[k]));
// 		f_data[k] = p;
// 	}
//
// 	return f_data;
...
// {
// 	ComplexVector X(N, std::complex(0.0, 0.0));
...
// 			std::complex angle(0.0, -2*M_PI*k/N);
//
